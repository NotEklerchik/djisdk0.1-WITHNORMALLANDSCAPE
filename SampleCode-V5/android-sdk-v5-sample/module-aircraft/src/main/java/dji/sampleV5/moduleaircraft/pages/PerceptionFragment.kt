...
/**
 * Description :Фрагмент модуля восприятия
 *
 * @author: Byte.Cai
 *  date : 2022/6/7
 *
...
class PerceptionFragment : DJIFragment(), CompoundButton.OnCheckedChangeListener {
    ...
    override fun onCheckedChanged(buttonView: CompoundButton?, isChecked: Boolean) {
        when (buttonView) {
            ...
            //Переключатель обхода препятствий
            ...
            //Переключатель предотвращения препятствий с помощью радара
